package com.siva.SpringJDBCDemo.controller;
...
import com.siva.SpringJDBCDemo.repository.TutorialRepository;
...
public class TutorialController {
	...
	public ResponseEntity<List<Tutorial>> getTutorials() {
		...
		return new ResponseEntity<List<Tutorial>>(tut, HttpStatus.ACCEPTED);
	 ...
	 public ResponseEntity<List<Tutorial>>findByPublished(@RequestParam("published")boolean published){
		 try {
			...
			if (tutorials.isEmpty()) {
				...
				System.out.println("List of tutorials published-->"+tutorials);
